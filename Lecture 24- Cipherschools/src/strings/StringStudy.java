...
public class StringStudy {
	public static void main(String[]args) {
	  ...
	  //6. Splitting
       ...
       //8. Finding index of a char in a string
	  	    ...
	  	    while(true)//infinite loop
		    {
	  	    ...
	  	    //9. Extract a sub string
	  	    System.out.println("*********************************");
	  	    System.out.println("9. Extract a substring");
	  	    String wf = "Wakanda Forever";
	  	    String subString = wf.substring(3);//From starting index included till the end of the string
	  	    System.out.println(subString);
	  	    
	  	  String subString2 = wf.substring(3,6);//From starting index included till the end  index  excluded of the string
	  	  System.out.println(subString2);
	  	  
	  	//10. Find the character of the given index
	  	    System.out.println("*********************************");
	  	    System.out.println("10. Find the character of the given index");
	  ...
	  //13. Comparing strings lexicographically -> alphabetically
  	    ...
  	    String textOne= "Hey!";
  	  String textTwo= "Bye!";
  	  System.out.println(textOne.compareTo(textTwo));//compares char by char
